...
public class SpecificItemModel {
    ...
    public SpecificItemModel() {

    }


    public SpecificItemModel (String image, String productTitle, String productLocation, String productCurrency, String productTime, String productRandom) {
        this.image = image;
