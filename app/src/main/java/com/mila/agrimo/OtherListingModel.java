...
public class OtherListingModel {
    ...
    public OtherListingModel() {
    }

    public OtherListingModel(String image, String productTitle, String productLocation, String productCurrency, String productTime, String productRandom) {
        this.image = image;
