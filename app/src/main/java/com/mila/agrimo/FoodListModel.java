...
public class FoodListModel {
    ...
    public FoodListModel(String userId, String productRandom, String productCategory, String image, String image1,
    ...
    public FoodListModel(String image, String productTitle, String productLocation, String productCurrency, String productTime, String productRandom) {
        this.image = image;
        this.productTitle = productTitle;
        this.productLocation = productLocation;
        this.productCurrency = productCurrency;
