...
public class FoodMarketplace extends AppCompatActivity {
    ...
    DatabaseReference countryRef, foodRef, ref, logOff;
    FirebaseUser user;
    ...
    private void init() {
        ...
        foodBrowseLocation = findViewById(R.id.foodBrowseLocation);
        slideImageModel = new ArrayList<>();
        bottomNavigationView = findViewById(R.id.foodBottomNavView);
        constraintLayout = findViewById(R.id.foodConstraintLayout);
        nes = findViewById(R.id.foodNes);
        appBar = findViewById(R.id.foodAppbar);
